...
//
//	printf("adad\r\n");
////	if( HAL_UART_Receive(&huart1, &pData, 1,1000)==HAL_OK)
...
//	HAL_UART_Receive(&huart2, RxBuffer, RxBufferSize, 50);
//	printf("\r\n%s\r\n\r\n",RxBuffer);
//	printf("hello\n\r");
//	  HAL_Delay(1000);
    /* USER CODE END WHILE */
...
//	  printf("%u\r\n",pData);
//	  if(pData==0) HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0, GPIO_PIN_RESET);
